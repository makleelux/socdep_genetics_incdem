...
final_vars_aug.imp1 %>%
  mutate(`Area-Level Socioeconomic Deprivation` = tdi_bin, 
         `Genetic Risk` = factor(case_when(Sprs_tert == "Q1" ~ "low",
                                           Sprs_tert == "Q2-4" ~ "intermediate",
                                           Sprs_tert == "Q5" ~ "high"))) %>% 
  ...
  kableExtra::row_spec(0, bold = T) %>% 
  kableExtra::kable_styling(position = "center", latex_options = c("HOLD_position")) %>% 
  kableExtra::column_spec(c(1, 2), width = "1.8cm") %>% 
...
model_row_individual("Low risk") %>%  
  ...
  rbind(model_row_individual("Intermediate risk")) %>% 
  ...
  rbind(model_row_individual("High risk")) %>% 
...
model_row_individual("Female") %>%  
  ...
  rbind(model_row_individual("Male")) %>% 
...
```{r}
cat("Complete Cases")
print_proportion_individual_deprivation_lifestyle(final_vars_aug) %>% 
  kable(format = "latex", align = "l", booktabs = TRUE) %>% 
  kableExtra::row_spec(0, bold = T) %>% 
  kableExtra::kable_styling(position = "center", latex_options = c("HOLD_position")) %>% 
  kableExtra::column_spec(1:5, width = "3cm")
...
cat("Imputed Data")
print_proportion_individual_deprivation_lifestyle(final_vars_aug.imp1) %>% 
  kable(format = "latex", align = "l", booktabs = TRUE)  %>% 
  kableExtra::row_spec(0, bold = T) %>% 
  kableExtra::kable_styling(position = "center", latex_options = c("HOLD_position")) %>% 
  kableExtra::column_spec(1:5, width = "3cm")
...
final_vars_aug %>% 
  ...
  print_proportion_individual_deprivation_lifestyle() %>% 
  kable(format = "latex", align = "l", booktabs = TRUE)  %>% 
  kableExtra::row_spec(0, bold = T) %>% 
  kableExtra::kable_styling(position = "center", latex_options = c("HOLD_position")) %>% 
  kableExtra::column_spec(1:5, width = "3cm")
...
print_hazards(res_area_5, exclude = c("pc", "degree", "sex", "edu", "age", "marital"))
#dev.off()
```
...
print_efigure2("./data/20211015bd_ls_part1.dta")
#dev.off()
```
